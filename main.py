...
parser.add_argument('--discriminator',  type=str,   default='discriminator',   help='run model')
parser.add_argument('--generator',  type=str,   default='generator',   help='run model')
